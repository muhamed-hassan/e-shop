...
public final class Endpoints {
    ...
    public static final String EDIT_VENDOR = "/vendors/{0}";
    ...
    public static final String EDIT_CATEGORY = "/categories/{0}";
    ...
    public static final String EDIT_PRODUCT = "/products/{0}";

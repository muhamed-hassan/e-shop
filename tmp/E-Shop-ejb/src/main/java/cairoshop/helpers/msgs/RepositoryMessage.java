package cairoshop.helpers.msgs;
...
public final class RepositoryMessage {
    ...
    public static final String AN_ERROR_OCCURED_DURING_ENTITY_RETRIEVAL = "An error occured during entity retrieval";
    public static final String AN_ERROR_OCCURED_DURING_COMPUTING_ENTITY_COUNT = "An error occured during computing entity's count";

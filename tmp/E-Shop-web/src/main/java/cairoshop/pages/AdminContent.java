...
public final class AdminContent extends SharedContent {
    ...
    public static final String EDIT_VENDOR = "/admin/manage-vendors/edit-vendor.xhtml";
    public static final String DELETE_VENDOR = "/admin/manage-vendors/delete-vendor.xhtml";
    
    public static final String MANAGE_USERS = "/admin/manage-users/manage-users.xhtml";
